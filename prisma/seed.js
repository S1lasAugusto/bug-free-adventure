    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          java = _a.sent();
          console.log(
            "\n ✅ Seeding completed! Only course structure and activities created."
          );
          console.log(
            " 📝 Users will be created through registration or API consumption."
          );
          return [2 /*return*/];
      }
    });
